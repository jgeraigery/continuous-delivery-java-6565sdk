...
/**
 * Unit test class for the GetToolchainByIdOptions model.
 */
public class GetToolchainByIdOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetToolchainByIdOptions() throws Throwable {
    GetToolchainByIdOptions getToolchainByIdOptionsModel = new GetToolchainByIdOptions.Builder()
      .toolchainId("testString")
      .build();
    assertEquals(getToolchainByIdOptionsModel.toolchainId(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetToolchainByIdOptionsError() throws Throwable {
    new GetToolchainByIdOptions.Builder().build();
  }
