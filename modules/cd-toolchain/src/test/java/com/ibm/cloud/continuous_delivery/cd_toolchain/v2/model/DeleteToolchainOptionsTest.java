...
/**
 * Unit test class for the DeleteToolchainOptions model.
 */
public class DeleteToolchainOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDeleteToolchainOptions() throws Throwable {
    DeleteToolchainOptions deleteToolchainOptionsModel = new DeleteToolchainOptions.Builder()
      .toolchainId("testString")
      .build();
    assertEquals(deleteToolchainOptionsModel.toolchainId(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDeleteToolchainOptionsError() throws Throwable {
    new DeleteToolchainOptions.Builder().build();
  }
