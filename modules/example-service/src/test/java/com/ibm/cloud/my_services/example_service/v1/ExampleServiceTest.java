...
public class ExampleServiceTest extends PowerMockTestCase {
  ...
  */
  ...
  public void testListResourcesWOptionsWRetries() throws Throwable {
    // Enable retries and run testListResourcesWOptions.
    exampleServiceService.enableRetries(4, 30);
    testListResourcesWOptions();

    // Disable retries and run testListResourcesWOptions.
  ...
  public void testCreateResourceWOptionsWRetries() throws Throwable {
    // Enable retries and run testCreateResourceWOptions.
    exampleServiceService.enableRetries(4, 30);
    testCreateResourceWOptions();

    // Disable retries and run testCreateResourceWOptions.
    exampleServiceService.disableRetries();
    testCreateResourceWOptions();
  }  
  ...
  public void testGetResourceWOptions() throws Throwable {
    // Schedule some responses.
    String mockResponseBody = "{\"resource_id\": \"resourceId\", \"name\": \"name\", \"tag\": \"tag\", \"read_only\": \"readOnly\"}";
    String getResourcePath = "/resources/1";
  ...
  public void testGetResourceWOptionsWRetries() throws Throwable {
    // Enable retries and run testGetResourceWOptions.
    exampleServiceService.enableRetries(4, 30);
    testGetResourceWOptions();

    // Disable retries and run testGetResourceWOptions.
    exampleServiceService.disableRetries();
    testGetResourceWOptions();
  }  
  ...
  public void testGetResourceEncodedWOptions() throws Throwable {
    // Schedule some responses.
    String mockResponseBody = "{\"resource_id\": \"resourceId\", \"name\": \"name\", \"tag\": \"tag\", \"read_only\": \"readOnly\"}";
    String getResourceEncodedPath = "/resources/encoded/url%253encoded%253resource%253id";
  ...
  public void testGetResourceEncodedWOptionsWRetries() throws Throwable {
    // Enable retries and run testGetResourceEncodedWOptions.
    exampleServiceService.enableRetries(4, 30);
    testGetResourceEncodedWOptions();

    // Disable retries and run testGetResourceEncodedWOptions.
    exampleServiceService.disableRetries();
    testGetResourceEncodedWOptions();
  }  
