...
/**
 * Unit test class for the LogsCollection model.
 */
public class LogsCollectionTest {
  ...
  @Test
  public void testLogsCollection() throws Throwable {
    LogsCollection logsCollectionModel = new LogsCollection();
    assertNull(logsCollectionModel.getLogs());
  }
}