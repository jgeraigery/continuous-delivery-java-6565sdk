...
/**
 * Unit test class for the PropertiesCollection model.
 */
public class PropertiesCollectionTest {
  ...
  @Test
  public void testPropertiesCollection() throws Throwable {
    PropertiesCollection propertiesCollectionModel = new PropertiesCollection();
    assertNull(propertiesCollectionModel.getXProperties());
  }
}