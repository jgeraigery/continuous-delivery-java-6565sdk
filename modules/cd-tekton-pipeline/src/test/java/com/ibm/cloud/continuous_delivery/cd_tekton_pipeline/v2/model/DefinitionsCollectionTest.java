...
/**
 * Unit test class for the DefinitionsCollection model.
 */
public class DefinitionsCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDefinitionsCollection() throws Throwable {
    DefinitionsCollection definitionsCollectionModel = new DefinitionsCollection();
    assertNull(definitionsCollectionModel.getDefinitions());
  }
}