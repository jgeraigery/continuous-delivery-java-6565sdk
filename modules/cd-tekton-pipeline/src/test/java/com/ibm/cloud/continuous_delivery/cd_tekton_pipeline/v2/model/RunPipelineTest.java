...
/**
 * Unit test class for the RunPipeline model.
 */
public class RunPipelineTest {
  ...
  @Test
  public void testRunPipeline() throws Throwable {
    RunPipeline runPipelineModel = new RunPipeline();
    assertNull(runPipelineModel.getId());
  }
}