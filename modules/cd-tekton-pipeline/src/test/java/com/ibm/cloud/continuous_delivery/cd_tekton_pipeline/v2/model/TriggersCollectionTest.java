...
/**
 * Unit test class for the TriggersCollection model.
 */
public class TriggersCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testTriggersCollection() throws Throwable {
    TriggersCollection triggersCollectionModel = new TriggersCollection();
    assertNull(triggersCollectionModel.getTriggers());
  }
}