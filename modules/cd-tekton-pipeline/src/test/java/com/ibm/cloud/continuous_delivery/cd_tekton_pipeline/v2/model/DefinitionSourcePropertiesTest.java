...
/**
 * Unit test class for the DefinitionSourceProperties model.
 */
public class DefinitionSourcePropertiesTest {
  ...
  public void testDefinitionSourceProperties() throws Throwable {
    ...
    DefinitionSourceProperties definitionSourcePropertiesModelNew = TestUtilities.deserialize(json, DefinitionSourceProperties.class);
    assertTrue(definitionSourcePropertiesModelNew instanceof DefinitionSourceProperties);
    assertEquals(definitionSourcePropertiesModelNew.url(), "testString");
  ...
  public void testDefinitionSourcePropertiesError() throws Throwable {
    new DefinitionSourceProperties.Builder().build();
  }
