...
/**
 * Unit test class for the RunDefinition model.
 */
public class RunDefinitionTest {
  ...
  @Test
  public void testRunDefinition() throws Throwable {
    RunDefinition runDefinitionModel = new RunDefinition();
    assertNull(runDefinitionModel.getId());
  }
}