 ...
 */
public class TriggerScmTriggerPropertiesItem extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(TriggerScmTriggerPropertiesItem triggerScmTriggerPropertiesItem) {
      this.name = triggerScmTriggerPropertiesItem.name;
      this.value = triggerScmTriggerPropertiesItem.value;
      this.xEnum = triggerScmTriggerPropertiesItem.xEnum;
      this.xDefault = triggerScmTriggerPropertiesItem.xDefault;
      this.type = triggerScmTriggerPropertiesItem.type;
      this.path = triggerScmTriggerPropertiesItem.path;
      this.href = triggerScmTriggerPropertiesItem.href;
    }
    ...
    /**
     * Builds a TriggerScmTriggerPropertiesItem.
     *
     * @return the new TriggerScmTriggerPropertiesItem instance
     */
    public TriggerScmTriggerPropertiesItem build() {
      return new TriggerScmTriggerPropertiesItem(this);
    }
     ...
     * @return the TriggerScmTriggerPropertiesItem builder
     */
  ...
  protected TriggerScmTriggerPropertiesItem(Builder builder) {
   ...
   * New builder.
   *
   * @return a TriggerScmTriggerPropertiesItem builder
   */
