...
public class TriggerPropertiesItem extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(TriggerPropertiesItem triggerPropertiesItem) {
      this.name = triggerPropertiesItem.name;
      this.value = triggerPropertiesItem.value;
      this.xEnum = triggerPropertiesItem.xEnum;
      this.xDefault = triggerPropertiesItem.xDefault;
      this.type = triggerPropertiesItem.type;
      this.path = triggerPropertiesItem.path;
      this.href = triggerPropertiesItem.href;
    }
    ...
    /**
     * Builds a TriggerPropertiesItem.
     *
     * @return the new TriggerPropertiesItem instance
     */
    public TriggerPropertiesItem build() {
      return new TriggerPropertiesItem(this);
    }
     ...
     * @return the TriggerPropertiesItem builder
     */
  ...
  protected TriggerPropertiesItem(Builder builder) {
   ...
   * New builder.
   *
   * @return a TriggerPropertiesItem builder
   */
