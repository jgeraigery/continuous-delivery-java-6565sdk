...
public class TriggerProperty extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(TriggerProperty triggerProperty) {
    ...
    /**
     * Builds a TriggerProperty.
     *
     * @return the new TriggerProperty instance
     */
    public TriggerProperty build() {
      return new TriggerProperty(this);
    }
     ...
     * @return the TriggerProperty builder
     */
  ...
  protected TriggerProperty(Builder builder) {
   ...
   * New builder.
   *
   * @return a TriggerProperty builder
   */
