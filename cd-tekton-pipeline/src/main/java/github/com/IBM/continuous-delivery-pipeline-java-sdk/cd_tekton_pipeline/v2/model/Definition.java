...
public class Definition extends GenericModel {
  ...
  public static class Builder {
     ...
     * @param id the id
     */
    public Builder(DefinitionScmSource scmSource, String serviceInstanceId, String id) {
  ...
  protected Definition(Builder builder) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(builder.scmSource,
      "scmSource cannot be null");
