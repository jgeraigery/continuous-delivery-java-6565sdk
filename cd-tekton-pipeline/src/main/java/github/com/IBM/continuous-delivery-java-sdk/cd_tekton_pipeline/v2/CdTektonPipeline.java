...
import github.com/IBM/continuous-delivery-java-sdk.common.SdkCommon;
 ...
 /**
  ...
  public ServiceCall<TektonPipeline> createTektonPipeline(CreateTektonPipelineOptions createTektonPipelineOptions) {
    ...
    if (!skipBody) {
      ...
      if (createTektonPipelineOptions.enableSlackNotifications() != null) {
        contentJson.addProperty("enable_slack_notifications", createTektonPipelineOptions.enableSlackNotifications());
      }
   ...
   * @return a {@link ServiceCall} with a result of type {@link Log}
   */
  public ServiceCall<Log> getTektonPipelineRunLogContent(GetTektonPipelineRunLogContentOptions getTektonPipelineRunLogContentOptions) {
    ...
    builder.header("Accept", "application/json");
    ResponseConverter<Log> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<Log>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
  ...
  public ServiceCall<Definition> createTektonPipelineDefinition(CreateTektonPipelineDefinitionOptions createTektonPipelineDefinitionOptions) {
    ...
    if (createTektonPipelineDefinitionOptions.id() != null) {
      contentJson.addProperty("id", createTektonPipelineDefinitionOptions.id());
    }
    builder.bodyJson(contentJson);
  ...
  public ServiceCall<Trigger> createTektonPipelineTrigger(CreateTektonPipelineTriggerOptions createTektonPipelineTriggerOptions) {
    ...
    if (createTektonPipelineTriggerOptions.disabled() != null) {
      contentJson.addProperty("disabled", createTektonPipelineTriggerOptions.disabled());
    }
    ...
    if (createTektonPipelineTriggerOptions.scmSource() != null) {
      contentJson.add("scm_source", com.ibm.cloud.sdk.core.util.GsonSingleton.getGson().toJsonTree(createTektonPipelineTriggerOptions.scmSource()));
    }
