...
/**
 * Unit test class for the PipelineRunsFirst model.
 */
public class PipelineRunsFirstTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPipelineRunsFirst() throws Throwable {
    PipelineRunsFirst pipelineRunsFirstModel = new PipelineRunsFirst();
    assertNull(pipelineRunsFirstModel.getHref());
  }
}