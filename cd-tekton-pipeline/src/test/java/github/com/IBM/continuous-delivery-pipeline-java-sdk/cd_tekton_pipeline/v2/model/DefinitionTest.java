...
/**
 * Unit test class for the Definition model.
 */
public class DefinitionTest {
  ...
  public void testDefinition() throws Throwable {
    ...
    Definition definitionModel = new Definition.Builder()
      .scmSource(definitionScmSourceModel)
      .serviceInstanceId("testString")
      .id("testString")
      .build();
    assertEquals(definitionModel.scmSource(), definitionScmSourceModel);
    assertEquals(definitionModel.serviceInstanceId(), "testString");
    assertEquals(definitionModel.id(), "testString");

    String json = TestUtilities.serialize(definitionModel);

    Definition definitionModelNew = TestUtilities.deserialize(json, Definition.class);
    assertTrue(definitionModelNew instanceof Definition);
    assertEquals(definitionModelNew.scmSource().toString(), definitionScmSourceModel.toString());
    assertEquals(definitionModelNew.serviceInstanceId(), "testString");
    assertEquals(definitionModelNew.id(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDefinitionError() throws Throwable {
    new Definition.Builder().build();
  }
