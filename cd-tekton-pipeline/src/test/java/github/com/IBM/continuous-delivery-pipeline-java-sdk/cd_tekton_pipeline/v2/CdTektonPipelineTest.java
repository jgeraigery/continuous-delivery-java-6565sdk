...
import github.com/IBM/continuous-delivery-pipeline-java-sdk.cd_tekton_pipeline.v2.CdTektonPipeline;
...
public class CdTektonPipelineTest extends PowerMockTestCase {
  ...
  public void testCreateTektonPipelineWOptions() throws Throwable {
    ...
    String mockResponseBody = "{\"name\": \"name\", \"status\": \"configured\", \"resource_group_id\": \"resourceGroupId\", \"toolchain\": {\"id\": \"id\", \"crn\": \"crn:v1:staging:public:toolchain:us-south:a/0ba224679d6c697f9baee5e14ade83ac:bf5fa00f-ddef-4298-b87b-aa8b6da0e1a6::\"}, \"id\": \"id\", \"definitions\": [{\"scm_source\": {\"url\": \"url\", \"branch\": \"branch\", \"tag\": \"tag\", \"path\": \"path\"}, \"service_instance_id\": \"serviceInstanceId\", \"id\": \"id\"}], \"properties\": [{\"name\": \"name\", \"value\": \"value\", \"enum\": [\"xEnum\"], \"default\": \"xDefault\", \"type\": \"SECURE\", \"path\": \"path\"}], \"updated_at\": \"2019-01-01T12:00:00.000Z\", \"created\": \"2019-01-01T12:00:00.000Z\", \"pipeline_definition\": {\"status\": \"updated\", \"id\": \"id\"}, \"triggers\": [{\"source_trigger_id\": \"sourceTriggerId\", \"name\": \"start-deploy\"}], \"worker\": {\"name\": \"name\", \"type\": \"private\", \"id\": \"id\"}, \"html_url\": \"htmlUrl\", \"build_number\": 1, \"enabled\": false}";
  ...
  public void testListTektonPipelineRunsWOptions() throws Throwable {
    ...
    Response<PipelineRuns> response = cdTektonPipelineService.listTektonPipelineRuns(listTektonPipelineRunsOptionsModel).execute();
    assertNotNull(response);
    PipelineRuns responseObj = response.getResult();
    assertNotNull(responseObj);
  ...
  public void testGetTektonPipelineRunLogsWOptions() throws Throwable {
    // Register a mock response
    String mockResponseBody = "{\"logs\": [{\"name\": \"name\", \"id\": \"id\", \"href\": \"href\"}]}";
    ...
    Response<PipelineRunLogs> response = cdTektonPipelineService.getTektonPipelineRunLogs(getTektonPipelineRunLogsOptionsModel).execute();
    assertNotNull(response);
    PipelineRunLogs responseObj = response.getResult();
    assertNotNull(responseObj);
  ...
  public void testGetTektonPipelineRunLogContentWOptions() throws Throwable {
    // Register a mock response
    String mockResponseBody = "{\"id\": \"id\", \"data\": \"data\"}";
  ...
  public void testListTektonPipelineDefinitionsWOptions() throws Throwable {
    ...
    Response<Definitions> response = cdTektonPipelineService.listTektonPipelineDefinitions(listTektonPipelineDefinitionsOptionsModel).execute();
    assertNotNull(response);
    Definitions responseObj = response.getResult();
    assertNotNull(responseObj);
  ...
  public void testListTektonPipelinePropertiesWOptions() throws Throwable {
    // Register a mock response
    String mockResponseBody = "{\"properties\": [{\"name\": \"name\", \"value\": \"value\", \"enum\": [\"xEnum\"], \"default\": \"xDefault\", \"type\": \"SECURE\", \"path\": \"path\"}]}";
    ...
    Response<EnvProperties> response = cdTektonPipelineService.listTektonPipelineProperties(listTektonPipelinePropertiesOptionsModel).execute();
    assertNotNull(response);
    EnvProperties responseObj = response.getResult();
    assertNotNull(responseObj);
    ...
    assertEquals(query.get("type"), RequestUtils.join(new java.util.ArrayList<String>(java.util.Arrays.asList("SECURE", "TEXT")), ","));
  ...
  public void testCreateTektonPipelinePropertiesWOptions() throws Throwable {
    // Register a mock response
    String mockResponseBody = "{\"name\": \"name\", \"value\": \"value\", \"enum\": [\"xEnum\"], \"default\": \"xDefault\", \"type\": \"SECURE\", \"path\": \"path\"}";
  ...
  public void testListTektonPipelineTriggersWOptions() throws Throwable {
    // Register a mock response
    String mockResponseBody = "{\"triggers\": [{\"href\": \"href\", \"source_trigger_id\": \"sourceTriggerId\", \"name\": \"start-deploy\"}]}";
    ...
    Response<Triggers> response = cdTektonPipelineService.listTektonPipelineTriggers(listTektonPipelineTriggersOptionsModel).execute();
    assertNotNull(response);
    Triggers responseObj = response.getResult();
    assertNotNull(responseObj);
  ...
  public void testCreateTektonPipelineTriggerWOptions() throws Throwable {
    // Register a mock response
    String mockResponseBody = "{\"source_trigger_id\": \"sourceTriggerId\", \"name\": \"start-deploy\"}";
  ...
  public void testListTektonPipelineTriggerPropertiesWOptions() throws Throwable {
    // Register a mock response
    String mockResponseBody = "{\"properties\": [{\"name\": \"name\", \"value\": \"value\", \"enum\": [\"xEnum\"], \"default\": \"xDefault\", \"type\": \"SECURE\", \"path\": \"path\", \"href\": \"href\"}]}";
    ...
    Response<TriggerProperties> response = cdTektonPipelineService.listTektonPipelineTriggerProperties(listTektonPipelineTriggerPropertiesOptionsModel).execute();
    assertNotNull(response);
    TriggerProperties responseObj = response.getResult();
    assertNotNull(responseObj);
