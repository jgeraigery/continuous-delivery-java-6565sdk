...
/**
 * Unit test class for the CreateTektonPipelinePropertiesOptions model.
 */
public class CreateTektonPipelinePropertiesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateTektonPipelinePropertiesOptions() throws Throwable {
    ...
    assertEquals(createTektonPipelinePropertiesOptionsModel.xEnum(), new java.util.ArrayList<String>(java.util.Arrays.asList("testString")));
    assertEquals(createTektonPipelinePropertiesOptionsModel.xDefault(), "testString");
  ...
  public void testCreateTektonPipelinePropertiesOptionsError() throws Throwable {
    new CreateTektonPipelinePropertiesOptions.Builder().build();
  }
