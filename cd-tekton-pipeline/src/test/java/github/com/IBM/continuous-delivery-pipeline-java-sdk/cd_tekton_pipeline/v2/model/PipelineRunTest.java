...
public class PipelineRunTest {
  ...
  public void testPipelineRun() throws Throwable {
    ...
    assertNull(pipelineRunModel.getEventHeaderParamsBlob());
    assertNull(pipelineRunModel.getXProperties());
    assertNull(pipelineRunModel.getCreated());
    assertNull(pipelineRunModel.getUpdated());
    assertNull(pipelineRunModel.getHtmlUrl());
  }
}