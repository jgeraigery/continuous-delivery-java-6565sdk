...
public class CreateTektonPipelineTriggerPropertiesOptionsTest {
  ...
  public void testCreateTektonPipelineTriggerPropertiesOptions() throws Throwable {
    ...
    assertEquals(createTektonPipelineTriggerPropertiesOptionsModel.xEnum(), new java.util.ArrayList<String>(java.util.Arrays.asList("testString")));
    assertEquals(createTektonPipelineTriggerPropertiesOptionsModel.xDefault(), "testString");
