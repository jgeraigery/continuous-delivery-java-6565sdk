...
public class CreateTektonPipelineRunOptionsTest {
  ...
  public void testCreateTektonPipelineRunOptions() throws Throwable {
    ...
    assertEquals(createTektonPipelineRunOptionsModel.triggerProperties(), new java.util.HashMap<String, Object>() { { put("foo", "testString"); } });
    assertEquals(createTektonPipelineRunOptionsModel.secureTriggerProperties(), new java.util.HashMap<String, Object>() { { put("foo", "testString"); } });
    assertEquals(createTektonPipelineRunOptionsModel.triggerHeader(), new java.util.HashMap<String, Object>() { { put("foo", "testString"); } });
    assertEquals(createTektonPipelineRunOptionsModel.triggerBody(), new java.util.HashMap<String, Object>() { { put("foo", "testString"); } });
  }
