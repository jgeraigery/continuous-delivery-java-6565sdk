...
/**
 * Unit test class for the PipelineRunsNext model.
 */
public class PipelineRunsNextTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPipelineRunsNext() throws Throwable {
    PipelineRunsNext pipelineRunsNextModel = new PipelineRunsNext();
    assertNull(pipelineRunsNextModel.getHref());
  }
}