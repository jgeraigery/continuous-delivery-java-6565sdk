...
/**
 * Unit test class for the Concurrency model.
 */
public class ConcurrencyTest {
  ...
  public void testConcurrency() throws Throwable {
    ...
    String json = TestUtilities.serialize(concurrencyModel);

    Concurrency concurrencyModelNew = TestUtilities.deserialize(json, Concurrency.class);
    assertTrue(concurrencyModelNew instanceof Concurrency);
    assertEquals(concurrencyModelNew.maxConcurrentRuns(), Long.valueOf("20"));
  }
}