...
import github.com/IBM/continuous-delivery-java-sdk.cd_tekton_pipeline.v2.model.EnvProperties;
...
/**
 * Unit test class for the EnvProperties model.
 */
public class EnvPropertiesTest {
  ...
  @Test
  public void testEnvProperties() throws Throwable {
    EnvProperties envPropertiesModel = new EnvProperties();
    assertNull(envPropertiesModel.getXProperties());
  }
}