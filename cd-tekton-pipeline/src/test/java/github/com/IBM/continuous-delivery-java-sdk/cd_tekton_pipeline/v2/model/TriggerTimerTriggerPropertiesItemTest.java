...
public class TriggerTimerTriggerPropertiesItemTest {
  ...
  public void testTriggerTimerTriggerPropertiesItem() throws Throwable {
    TriggerTimerTriggerPropertiesItem triggerTimerTriggerPropertiesItemModel = new TriggerTimerTriggerPropertiesItem();
    assertNull(triggerTimerTriggerPropertiesItemModel.getName());
    assertNull(triggerTimerTriggerPropertiesItemModel.getValue());
    assertNull(triggerTimerTriggerPropertiesItemModel.getXEnum());
    assertNull(triggerTimerTriggerPropertiesItemModel.getType());
    assertNull(triggerTimerTriggerPropertiesItemModel.getPath());
    assertNull(triggerTimerTriggerPropertiesItemModel.getHref());
  }
}