...
/**
 * Unit test class for the Events model.
 */
public class EventsTest {
  ...
  public void testEvents() throws Throwable {
    ...
    String json = TestUtilities.serialize(eventsModel);

    Events eventsModelNew = TestUtilities.deserialize(json, Events.class);
    assertTrue(eventsModelNew instanceof Events);
    assertEquals(eventsModelNew.push(), Boolean.valueOf(true));
    assertEquals(eventsModelNew.pullRequestClosed(), Boolean.valueOf(true));
    assertEquals(eventsModelNew.pullRequest(), Boolean.valueOf(true));
  }
}